...
import com.oliveiraz.practice.entities.Payment;
...
import com.oliveiraz.practice.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// Associação de objetos no Paradigma Orientado a Objetos //
		...
		Order o2 = new Order(null, Instant.parse("2024-02-21T03:42:10Z"),OrderStatus.DELIVERED, u2);
		...
		Payment pay1 = new Payment(null, Instant.parse("2024-02-21T05:42:10Z"), o1);
		o1.setPaymnet(pay1);	
